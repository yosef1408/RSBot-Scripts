...
public class WorldHelper {
    ...
    public boolean shouldHop(){
        ...
        boolean notEnoughFish = collectedFish < ((sessionTime / 60 / 60) * 500); // more than 500 fish expected per hour
    ...
    public void randomWorldHop(){
        ...
        ctx.worlds.select()
                ...
                .types(World.Type.FREE).shuffle().poll().hop(); // Filters all worlds which are free
