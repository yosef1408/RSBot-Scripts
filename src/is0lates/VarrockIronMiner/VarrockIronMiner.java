...
@Script.Manifest(name = "Varrock Iron Miner", description = "Mines iron near Varrock", properties = "client=6; topic=0")
public class VarrockIronMiner extends PollingScript<ClientContext> {
