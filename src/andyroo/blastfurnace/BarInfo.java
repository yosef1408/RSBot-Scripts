...
public class BarInfo {
    ...
    private static final int ADAMANTITE_MASK = 0x1F;
    private static final int ADAMANTITE_SHIFT = 0;
    private static final int RUNITE_MASK = 0x1F00;
    private static final int RUNITE_SHIFT = 2 * 4;
    ...
    public BarInfo(BlastFurnace.BAR barType) {
        ...
        if (barType == BlastFurnace.BAR.RUNITE) {
            ...
            oreVarpbit = ORE_INFO_VARPBIT2;
            barVarpbit = BAR_INFO_VARPBIT2;
            primaryMask = RUNITE_MASK;
            primaryShift = RUNITE_SHIFT;
