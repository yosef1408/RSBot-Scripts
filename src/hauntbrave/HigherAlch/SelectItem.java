...
public class SelectItem extends ClientAccessor {

	private final String greeting = "Welcome to HigherAlch! - By hauntbrave";
	private final String prompt = "<html>Please enter a item's ID <br>(noted item Ids are +1 their regular Id)...</html>";
	...
	public SelectItem(ClientContext ctx){ super(ctx); prepGUI(); }
