 ...
 */
@Script.Manifest(
name = "Granite Splitter", properties = "author=Chaoran Wang; topic=-2; client=6;",
        description = "Splitting Granite 5kg to 500g and make huge profit off it!"
)
public class GraniteSpliter extends PollingScript<ClientContext> implements PaintListener {
...
//                } else {
                    ...
                    Condition.wait(new Callable<Boolean>() {
                        @Override
                        public Boolean call() {
                            return ctx.bank.withdraw(graniteIDs[2], 3);
                        }
                    });
//                }
...
//                    }, 1, 16000);
    ...
    private GraniteSpliter.State state() {
