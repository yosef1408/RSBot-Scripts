 ...
 */
@Script.Manifest(description = "Will crack the safe's at Rogue's den.Check the forums once before you use it.", name = "[A][T]ProjectLocker", properties = "author=Terminator1; topic=-1; client=4;")
